...
class ZCycleViewCell: UICollectionViewCell {
    ...
    func attributeString(_ attributeString: NSAttributedString?, titleImgURL: String? = nil, titleImage: UIImage? = nil, titleImageSize: CGSize? = nil) {
        ...
        {
            titleImageView.frame = CGRect(x: 5,
                                          y: (containerViewSize.height-imageSize.height)/2,
                                          width: imageSize.width,
                                          height: imageSize.height)
            titleLabel.frame = CGRect(x: 6+imageSize.width,
                                      y: 0,
                                      width: containerViewSize.width-6-imageSize.width,
        ...
        else
        {
            ...
            titleLabel.frame = CGRect(x: 5,
                                      y: 0,
                                      width: containerViewSize.width-5,
                                      height: containerViewSize.height)
        }
